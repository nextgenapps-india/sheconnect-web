...
import HomeCurtainIntro from "@/components/HomeCurtainIntro";
          ...
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div className="z-10">
              ...
              <p className="text-xl text-purple-100 mb-8 max-w-lg">
                A powerful community where women grow, rise, and succeed
                together. Bridging the gap between potential and platform.
              </p>
        ...
        <section className="py-24 px-6 bg-white">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              $heConnect is a powerful women-led community designed to help
              Indian women Start, Grow, and Scale with Confidence.
            </p>
          </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
              ...
              <p className="text-gray-500 max-w-sm">
                Strategic networking, brand visibility, and real connections,
                not just content.
              </p>
            </div>
